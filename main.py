...
def add():
    CSV.initialize_csv()
    date = get_date("enter the date in the format dd-mm-yyyy or enter for today's date: ", allow_default=True)
    amount = get_amount()
...
def main():
    while True:
        ...
        if choice == "1":
            ...
            start_date = get_date("Enter your start date (dd-mm-yyyy): ")
            end_date = get_date("Enter your end date (dd-mm-yyyy: ")
